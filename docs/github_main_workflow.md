...
- 修改 @docs/github_main_workflow.md  【### 8. 发布 release tag（按需）】中的 【##### 第 3 步：创建 GitHub Release】中的命令，写好title 并更新根目录 RELEASE.md ，RELEASE.md 里要有贡献者 mention。
...
- 在仓库根目录运行该命令；`RELEASE.md` 是本次 GitHub Release 的用户向 release notes。
