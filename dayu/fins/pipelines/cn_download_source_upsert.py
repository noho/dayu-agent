...
def commit_cn_filing_source_document(
    *,
    ...
    Args:
        ...
        previous_meta: 写入前 source meta；不存在时为 ``None``。
    ...
    meta["document_version"] = _resolve_document_version(previous_meta, source_fingerprint)
    request = _build_upsert_request(
        ticker=ticker,
        document_id=document_id,
        internal_document_id=internal_document_id,
        ...
        file_entries=file_entries,
        meta=meta,
        previous_meta_exists=previous_meta is not None,
    )
