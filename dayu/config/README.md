...
```json
{
  ...
  "model": {
    ...
    "allowed_names": ["mimo-v2.5-pro", "mimo-v2.5-pro", "mimo-v2.5-pro-plan", "mimo-v2.5-pro-plan-sg", "deepseek-v4-flash", "qwen3", "gpt-5.4", "claude-sonnet-4-6", "gemini-2.5-flash"],
...
- 项目内当前建议温度口径统一为：`mimo-v2.5-pro = write 0.8 / overview 0.3`、`mimo-v2.5-pro-thinking = prompt 0.8 / interactive 0.8 / audit 0.4`、`deepseek-v4-flash-thinking = prompt 1.3 / interactive 1.3 / audit 0.8`、`qwen3-thinking = prompt 0.6 / interactive 0.6 / audit 0.2`。
